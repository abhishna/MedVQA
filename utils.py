...
def get_model(model_type, vocab_size, use_image_embedding, use_dropout, output_size, image_model_type, attention_mechanism, word_embedding_size, lstm_state_size, bi_directional = False, max_length = 14, use_glove = False, use_lstm = True, use_bert = False, embedding_file_path = None, use_clip = False):
    """
    ...
    if model_type == 'baseline':
        model = VQABaseline(vocab_size = vocab_size, use_image_embedding = use_image_embedding, use_dropout = use_dropout,
                            ...
                            word_embedding_size = word_embedding_size, lstm_hidden_size = lstm_state_size, bi_directional = bi_directional, max_seq_len = max_length, use_glove = use_glove, use_lstm = use_lstm, use_bert = use_bert, embedding_file_path = embedding_file_path, use_clip = use_clip)
    else:
